...
void Rain::Reset()
{
	...
	for (UINT i = 0; i < particleCount; i++)
	{
		...
		if (scale.y < 0.0f)scale.y = 0.0001f;
...
void Rain::RenderDetail()
{
	...
	if (ImGui::BeginTabBar("MyTabBar3"))
	{
		...
		{
			Particle::Gui();
			ImGui::InputFloat3("velocity", (float*)&desc.velocity);
			ImGui::InputFloat3("particleRange", (float*)&desc.range);
			ImGui::InputFloat2("particleSize", (float*)&scale);
			ImGui::InputFloat2("particleRandomSizeRange", (float*)&particleScale);
			ImGui::InputInt("particleCount", &particleCount);
