...
void Input::Update()
{
    ...
    if (hideMouse)
    {
        ...
        {
            movePosition.x = last.x - center.x;
            movePosition.y = last.y - center.y;
        }
    


        currentPostion.x = App.GetHalfWidth();
        currentPostion.y = App.GetHalfHeight();
