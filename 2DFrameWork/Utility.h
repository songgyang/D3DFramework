...
namespace Utility
{
    ...
    float LerpAngle(float src, float dest, float w);
    ...
    Vector3 WorldToScreen(Vector3 worldPos, Camera* cam = Camera::main);
    float GetCamDistance(Vector3 worldPos, Camera* cam = Camera::main);
